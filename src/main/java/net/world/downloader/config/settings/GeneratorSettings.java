...
import net.world.downloader.config.Setting;
import net.world.downloader.config.StringSetting;
...
public final class GeneratorSettings {
	...
	public enum Generator {
		...
		SINGLE_BIOME_SURFACE("single biome", "", 0, ""),
		SINGLE_BIOME_CAVES("single biome caves", "", 0, ""),
		SINGLE_BIOME_FLOATING_ISLANDS("single biome floating islands", "", 0, ""),
		LEGACY("legacy", "default_1_1", 0, ""); // XXX do we really need this?

		private final String confName;
		private static final Map<String, Generator> FROM_STRING = SettingsUtils.makeFromString(values(),
				t -> t.confName);
		...
		private Generator(String confName, String generatorName, int generatorVersion,
	...
	private static class GeneratorSetting implements CyclableSetting<Generator> {
		...
		@Override
		public Text getButtonText(Generator curValue) {
