...
public final class MessageSettings {
	...
	public static class MessageCategorySetting implements CyclableSetting<Boolean> {
		...
		@Override
		public Text getButtonText(Boolean curValue) {
			return new TranslatableText("wdl.gui.messages.group." + curValue);
		}
	...
	public static class MessageTypeSetting implements CyclableSetting<Boolean> {
		...
		@Override
		public Text getButtonText(Boolean curValue) {
			return new TranslatableText("wdl.gui.messages.message." + curValue, registration.type.getDisplayName());
		}
