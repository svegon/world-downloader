...
public class ButtonDisplayGui extends WDLButton {
	...
	public ButtonDisplayGui(int x, int y, int widthIn, int heightIn, @Nullable Screen screen) {
		this(x, y, widthIn, heightIn, I18n.translate("gui.done"), screen);
	}
	...
	public ButtonDisplayGui(int x, int y, int widthIn, int heightIn, Supplier<? extends Screen> supplier) {
		this(x, y, widthIn, heightIn, I18n.translate("gui.done"), supplier);
	}

	/**
	 * Creates a new button that displays the given screen, with the specified text.
	 */
	public ButtonDisplayGui(int x, int y, int widthIn, int heightIn, String buttonText,
	 ...
	 * Creates a new button that displays the given screen, with the specified text.
	 */
	public ButtonDisplayGui(int x, int y, int widthIn, int heightIn, Text buttonText,
			@Nullable Screen screen) {
		this(x, y, widthIn, heightIn, buttonText, () -> screen);
	}
	 ...
	 */
	public ButtonDisplayGui(int x, int y, int widthIn, int heightIn, String buttonText,
			Supplier<? extends Screen> supplier) {
	...
	public void performAction() {
		MinecraftClient.getInstance().openScreen(this.screenSupplier.get());
	}
}
