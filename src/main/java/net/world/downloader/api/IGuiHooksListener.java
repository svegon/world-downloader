...
public interface IGuiHooksListener extends IWDLMod {
	 ...
	 */
	public abstract boolean onBlockGuiClosed(ClientWorld world, BlockPos pos, ScreenHandler container);
	 ...
	 *         returned, it'll be passed on to the next mod).
	 */
	public abstract boolean onEntityGuiClosed(ClientWorld world, Entity entity, ScreenHandler container);
}
