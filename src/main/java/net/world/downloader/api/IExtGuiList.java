 ...
 */
public interface IExtGuiList<T extends IExtGuiList.IExtGuiListEntry<T>> {
	public static interface IExtGuiListEntry<T> {
		/**
		 ...
		 */
		public abstract <B extends ButtonWidget> B addButton(B button, int x, int y);
		 ...
		 * @param mo@Override
		useButton The button that was pressed.
