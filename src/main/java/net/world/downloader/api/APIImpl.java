...
import net.world.downloader.config.settings.MiscSettings.ExtensionEnabledSetting;
import net.world.downloader.handler.HologramHandler;
import net.world.downloader.utils.EntityRealigner;
...
public class APIImpl implements WDLApi.APIInstance {
	...
	private static class ModMessageTypeCategory extends MessageTypeCategory {
		...
		public Text getDisplayName() {
			return new LiteralText(mod.getDisplayName());
		}

		@Override
		public Text getDescription() {
			return new TranslatableText("Messages for " + mod.getDisplayName()); // XXX Not translated
		}
	}
