...
public interface IEntityManager extends IWDLMod {
	 ...
	 */
	@Nullable
	public abstract String getIdentifierFor(@NotNull Entity entity);
	 ...
	 * @see #getProvidedEntities()
	 */
	public abstract int getTrackDistance(@NotNull String identifier, @Nullable Entity entity);
	 ...
	 */
	@Nullable
	public abstract String getGroup(@NotNull String identifier);
	 ...
	 */
	@Nullable
	public abstract String getDisplayIdentifier(@NotNull String identifier);
	 ...
	 */
	@Nullable
	public abstract String getDisplayGroup(@NotNull String group);
	 ...
	 */
	public abstract boolean enabledByDefault(@NotNull String identifier);
}
