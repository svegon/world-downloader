...
public class VersionConstants {
	...
	public static String getMinecraftVersionInfo() {
		...
		String launchedVersion = MinecraftClient.getInstance().getGameVersion();
		String brand = ClientBrandRetriever.getClientModName();
		String versionType = MinecraftClient.getInstance().getVersionType();
