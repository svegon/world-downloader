...
import net.world.downloader.config.settings.EntitySettings.TrackDistanceMode;
import net.world.downloader.handler.StandardEntityManagers;
...
public class EntityUtils {
	...
	public static String getEntityType(@Nonnull Entity e) {
		if (e instanceof PlayerEntity || e instanceof LightningEntity) {
