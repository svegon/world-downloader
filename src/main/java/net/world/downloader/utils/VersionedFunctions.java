...
public final class VersionedFunctions {
	 ...
	 * @param blockEntityTag
	 *            The full Tag tag of the existing block entity. May be used if
	...
	public static boolean shouldImportBlockEntity(String entityID, BlockPos pos,
			Block block, CompoundTag blockEntityTag, Chunk chunk) {
		return HandlerFunctions.shouldImportBlockEntity(entityID, pos, block, blockEntityTag, chunk);
	}
	...
	/**
	 * Writes additional player Tag not handled by {@link ClientPlayerEntity#writeAdditional}.
	 *
	 ...
	 * @param Tag The (partially already populated) Tag.
	 */
	public static void writeAdditionalPlayerData(ClientPlayerEntity player, CompoundTag Tag) {
		HandlerFunctions.writeAdditionalPlayerData(player, Tag);
	}

	/**
	 * Gets the world info Tag, which goes into level.dat.
	 *
	 * @param world The world.
	 * @param playerTag The player's Tag data.
	 * @return The world info Tag data.
	 */
	public static CompoundTag getWorldInfoNbt(ClientWorld world, CompoundTag playerTag) {
		return HandlerFunctions.getWorldInfoNbt(world, playerTag);
	}
	...
	public static String asString(Tag tag) {
		return NBTFunctions.asString(tag);
	}

	/**
	 * Creates an Tag list based on the given float values.
	 *
	...
	/**
	 * Creates an Tag list based on the given double values.
	 *
	 * @param values The varargs array of values.
	 * @return A new list tag.
	 */
	...
	/**
	 * Creates an Tag list based on the given short values.
	 *
	 * @param values The varargs array of values.
	 * @return A new list tag.
	 */
	...
	/**
	 * Creates an Tag string based on the given string.
	 *
	 ...
	 */
	public static CustomPayloadC2SPacket makePluginMessagePacket(@ChannelName String channel, byte[] bytes) {
	 ...
	 * @return The new packet.
	 */
	public static CustomPayloadS2CPacket makeServerPluginMessagePacket(@ChannelName String channel, byte[] bytes) {
	 ...
	 */
	@Nullable
	public static MapState getMapData(World world, MapUpdateS2CPacket packet) {
		return MapFunctions.getMapData(world, packet);
	}
	...
	/**
	 * Creates a new GameRules object populated with the given Tag.
	 *
	 * @return The new GameRules object
	 */
	public static GameRules loadGameRules(CompoundTag Tag) {
		return GameRuleFunctions.loadGameRules(Tag);
	}
	...
	/**
	 * Writes the generator options into the given Tag.
	 *
	 * @param worldInfoTag The Data tag for the world.
	 ...
	 */
	public static void writeGeneratorOptions(CompoundTag worldInfoTag, long randomSeed,
			boolean mapFeatures, String generatorName, String generatorOptions, int generatorVersion) {
		GeneratorFunctions.writeGeneratorOptions(worldInfoTag, randomSeed, mapFeatures,
				generatorName, generatorOptions, generatorVersion);
	}
	 ...
	 */
	public static ClientPlayerEntity makePlayer(MinecraftClient minecraft, World world, ClientPlayNetworkHandler nhpc, ClientPlayerEntity base) {
	 ...
	 */
	public static Object getPointOfView(GameOptions settings) {
	 ...
	 */
	public static ConfirmScreen createConfirmScreen(BooleanConsumer action, Text line1, Text line2,
