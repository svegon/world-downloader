...
public class ReflectionUtils {
	 ...
	 *            The class to check
	 */
	// The creative inventory CreativeInventoryScreen.INVENTORY is an instance of Inventory
	public static boolean isCreativeContainer(Class<? extends ScreenHandler> containerClass) {
		try {
			return CreativeInventoryScreen.class.equals(containerClass.getEnclosingClass());
		} catch (Exception e) {
