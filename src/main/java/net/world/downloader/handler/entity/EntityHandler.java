 ...
 */
public abstract class EntityHandler<E extends Entity, C extends ScreenHandler> extends BaseHandler {
	/**
	 * Constructor.
	 *
	 * @param entityClass
	 ...
	 */
	public final boolean checkRidingCasting(ScreenHandler container, Entity entity)
			throws ClassCastException {
	 ...
	 *             If container or entity are not instances of the handled class.
	 */
	public final Text copyDataCasting(ScreenHandler container, Entity entity, boolean riding)
	 ...
	 *             When something is handled wrong.
	 */
	public abstract Text copyData(C container, E entity, boolean riding) throws HandlerException;
	...
	@Nullable
	public static <E extends Entity, C extends ScreenHandler> EntityHandler<? super E, ? super C> 
			getHandler(Class<E> entityClass, Class<C> containerClass) {
